...
- Name: UI\admin.spec.ts >> Admin User Management >> TC03 - Edit Admin User
- Location: tests\UI\admin.spec.ts:41:9
...
Call log:
  - waiting for locator('//div[@role=\'table\']').locator('[role=\'row\']').filter({ hasText: 'Hello' }).locator('button').nth(1)
...
- generic [ref=f2e3]:
  ...
  - generic [ref=f2e155]:
    - generic [ref=f2e157]:
      ...
      - generic [ref=f2e209]:
        ...
        - generic [ref=f2e213]:
          ...
          - generic [ref=f2e215]: (17) Records Found
        - table [ref=f2e218]:
          - rowgroup [ref=f2e219]:
            - row [ref=f2e220]:
            ...
            - row [ref=f2e266]:
              - cell "" [ref=f2e267]:
                - generic [ref=f2e270] [cursor=pointer]:
                  - checkbox "" [ref=f2e271]
                  - generic [ref=f2e272]: 
              - cell "AutoUser1790179960255" [ref=f2e274]
              - cell "Admin" [ref=f2e276]
              - cell "manda user" [ref=f2e278]
              - cell "Disabled" [ref=f2e280]
              - cell [ref=f2e282]:
                - generic [ref=f2e283]:
            ...
            - row [ref=f2e289]:
              - cell "" [ref=f2e290]:
                - generic [ref=f2e293] [cursor=pointer]:
                  - checkbox "" [ref=f2e294]
                  - generic [ref=f2e295]: 
              - cell "AutoUser1790180531937" [ref=f2e297]
            ...
            - row [ref=f2e335]:
              - cell "" [ref=f2e336]:
                - generic [ref=f2e339] [cursor=pointer]:
                  - checkbox "" [ref=f2e340]
                  - generic [ref=f2e341]: 
              - cell "disposable.user.1790180078301" [ref=f2e343]
              - cell "Admin" [ref=f2e345]
              - cell "123445 444444" [ref=f2e347]
              - cell "Disabled" [ref=f2e349]
              - cell [ref=f2e351]:
                - generic [ref=f2e352]:
            ...
            - row [ref=f2e358]:
              - cell "" [ref=f2e359]:
                - generic [ref=f2e362] [cursor=pointer]:
                  - checkbox "" [ref=f2e363]
                  - generic [ref=f2e364]: 
              - cell "e2e_m4b1r_bulk1_1790182028" [ref=f2e366]
              - cell "ESS" [ref=f2e368]
              - cell "manda user" [ref=f2e370]
            ...
            - row [ref=f2e381]:
              - cell "" [ref=f2e382]:
                - generic [ref=f2e385] [cursor=pointer]:
                  - checkbox "" [ref=f2e386]
                  - generic [ref=f2e387]: 
              - cell "e2e_m4b1r_bulk2_1790182028" [ref=f2e389]
              - cell "ESS" [ref=f2e391]
            ...
            - row [ref=f2e611]:
              - cell "" [ref=f2e612]:
                - generic [ref=f2e615] [cursor=pointer]:
                  - checkbox "" [ref=f2e616]
                  - generic [ref=f2e617]: 
              - cell "username1790182890329" [ref=f2e619]
              - cell "Admin" [ref=f2e621]
              - cell "A8DCo 010Z" [ref=f2e623]
    ...
    - generic [ref=f2e634]:
      - paragraph [ref=f2e635]: OrangeHRM OS 5.9
      - paragraph [ref=f2e636]:
        - text: © 2005 - 2026
        - link "OrangeHRM, Inc" [ref=f2e637] [cursor=pointer]:
...
```ts
  49  |     
  50  |     this.admin_username = page
  51  |     .locator(".oxd-input-group")
  52  |     .filter({ hasText: /^Username$/ })
  53  |     .locator("input");
  54  |     
  55  | 
  56  |     //this.user_password=page.locator("//input[@type='password' and @class='oxd-input oxd-input--focus']");
  57  |     this.user_password = page
  58  |     .locator(".oxd-input-group")
  59  |     .filter({ hasText: /^Password$/ })
  60  |     .locator("input");
  61  |     //this.cnfrm_password=page.locator("//input[@type='password' and @class='oxd-input oxd-input--focus']");
  62  |     this.cnfrm_password = page
